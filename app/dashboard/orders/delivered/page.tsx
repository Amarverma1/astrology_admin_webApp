        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h3 className="font-semibold text-gray-700">Total Delivered</h3>
                        </div>
                        <p className="text-2xl font-bold text-gray-900">{orders.length}</p>
                        <p className="text-xs text-gray-500 mt-1">All-time successful deliveries</p>
                    </div>
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition">
                        ...
                        <p className="text-xs text-gray-500 mt-1">From all delivered orders</p>
                    </div>
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition">
                        ...
                        <p className="text-xs text-gray-500 mt-1">Per successful delivery</p>
                    </div>

                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition">
                        <div className="flex items-center gap-3 mb-2">
                            <PieChart className="w-5 h-5 text-purple-600" />
                            <h3 className="font-semibold text-gray-700">Top Category</h3>
                        </div>
                        <p className="text-2xl font-bold text-gray-900">Dishes</p>
                        <p className="text-xs text-gray-500 mt-1">Most delivered product type</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 ">
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100n hover:shadow-md transition">
                        <h2 className="text-sm font-semibold text-gray-600 mb-3 hover:shadow-md transition">
                            Top Categories
                        </h2>
                ...
                <div className="fixed inset-0 z-50 flex justify-end bg-black/30 backdrop-blur-sm">
                    <div className="bg-white w-full sm:w-[460px] h-full shadow-xl p-6 flex flex-col animate-slideIn">
                        ...
                        <div className="space-y-2 text-sm text-gray-700 mb-4">
                            ...
                            <p><strong>Delivered On:</strong> {selectedOrder.deliveryDate}</p>
                        </div>
